...
def main():
    ...
    # parser.add_option("--help", "--show-help", dest="show_help_option", action="store_true", help="Show this help message and exit")
    ...
    set_google_credentials(options.credentials_path)
    
    # Call the functions with the specified options
...
def download_file(youtube_url, credentials_path, output_file='recognized.txt', download_path="."):
